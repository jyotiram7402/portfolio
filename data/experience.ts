...
export const experience: readonly ExperienceEntry[] = [
  {
    ...
    responsibilities: [
      ...
      "Own the standards for safe AI usage — what a tool may read, where it runs, and what has to be isolated before it touches company data. That covers Claude Code, CLAUDE.md conventions, MCP servers and the permission model each one runs under.",
      "Run the evaluations end to end: research the tool, assess it against corporate network and developer-machine security, build a working integration in a real codebase, then demonstrate it live to leadership on genuine development scenarios rather than a scripted demo.",
      "Present findings and recommendations to the IT Director, managers and team leads, translating experiments into decisions the team can act on.",
      "Support engineers moving onto agentic workflows, so adoption is a capability rather than a mandate.",
    ],
    achievements: [
      "Identified that agentic AI tooling could reach files outside the intended project boundary on a developer machine, and engineered a Docker-based DevContainer giving a fully isolated environment — adopted as the standard workflow by all 20 developers.",
      "Took Claude Code from an R&D spike to an organisation-wide standard, with the security question answered before rollout rather than after. The research is what let the organisation widen AI tooling access to developers instead of holding it back.",
      "Researched and built a Playwright MCP setup for AI-driven browser automation — Docker, YAML configuration and automated testing workflows — demonstrated it to the manager and the QA team, and saw it adopted by QA. The second thing I took from research to adoption.",
    ],
    technologies: [
      "Claude Code",
      "MCP",
  ...
  },
  {
    ...
    location: "Pune, India · On-site",
    summary:
      "Backend and integration ownership on an enterprise commerce platform: four payment gateways, CRM and marketing data synchronisation over REST, an AI-powered search service, and a containerised configurator built from scratch. The first six months were enterprise CRM and marketing integration; payments and production ownership followed.",
    responsibilities: [
      "Own end-to-end payment gateway integrations for PayPal, Stripe, AsiaPay (China/APAC) and CCAvenue, and act as the single point of contact for every payment issue in production.",
      "Work across each provider's API and SDK — authentication, request and response contracts, transaction flows, error handling and the security requirements that differ per gateway.",
      ...
      "Integrate enterprise CRM and marketing platforms over REST APIs, synchronising customer, product and campaign data so downstream systems consume one structured shape rather than four.",
      "Extend and debug a large legacy JavaScript codebase, working from its existing architecture and MySQL schema rather than around them — the first six months were almost entirely this.",
      ...
      "Own production support: live integration failures, legacy defects and emergency fixes, taken through root-cause analysis rather than patched at the symptom. A break in a payment integration hits customer transactions directly, so these are read as system problems, not just code ones.",
      "Deliver in an Agile environment (Jira, Workfront), through code review and sprint planning with client teams.",
    ...
    achievements: [
      ...
      "Became the single point of contact for payments across four providers inside the first year — the escalation path when a transaction does not settle.",
    ],
    technologies: [
      "Java",
      "Spring Boot",
