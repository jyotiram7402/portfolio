...
export const narrative = {
  ...
  introduction: `${identity.firstName} is a ${identity.role.toLowerCase()} based in ${identity.location}, with two years on enterprise backend systems. He builds Spring Boot services, owns four payment gateways end to end, and sits on Southco's AI board leading the AI-first approach to development.`,

  /** Answer to "tell me about his experience". */
  experienceSummary:
    "He is a Junior Web Developer for backend and integrations at Southco (September 2024 to present), and a board member of the company's AI team. The backend work is payment gateway ownership across PayPal, Stripe, AsiaPay and CCAvenue, enterprise CRM and marketing data synchronisation over REST, an AI-powered search service on OpenSearch, and a containerised FastAPI configurator built from scratch. As a board member he leads the AI-first development initiative — he found that agentic AI tooling could read legacy customer data, engineered an isolated Docker DevContainer, and saw it adopted as the standard workflow by all 20 developers. Before Southco he spent six months as a Java Back End Developer at ProAzure Software Solutions (January to June 2023), working on the pre-Boot stack — JDBC, Servlets, JSP, Spring and Hibernate — and five months on Zensar Technologies' Employment Skills Development apprenticeship, where the database design material is what transferred. That internship is the reason the Java experience is professional rather than only personal: the day job at Southco is backend and integrations rather than Java.",

  /** The differentiator, asked about often enough to deserve its own answer. */
  aiLeadership:
    "He is a board member of the AI team at Southco, leading the AI-first approach to development across the engineering organisation. That covers which agentic tools get adopted, what they are permitted to read, and how the team actually moves onto them. He led the R&D on Claude Code, presented the findings to the IT Director, managers and team leads, and built the secure DevContainer that made adoption possible for all 20 developers. He then did the same with Playwright MCP for AI-driven browser automation, demonstrated it to the manager and the QA team, and saw QA adopt it.",
